  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-16">
      ...
      <p className="mt-4 text-[#5c564c]">
        Enviamos con Correos en sobre o paquete pequeño. Sale como muy tarde en 24 h. El
        código postal decide la zona y la tarifa.
      </p>
      ...
      <p className="mt-6 text-sm text-[#7a7266]">
        Sale en 24 h como muy tarde. Las tarifas de arriba son las que cobra la web ahora
        mismo.
      </p>
    </div>
  );
